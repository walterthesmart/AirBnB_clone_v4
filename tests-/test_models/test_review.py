...
"""
This script contains the TestReviewDocs classes
"""
...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_review(self):
        """Tests that models/review.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_review(self):
        """Tesst that tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_module_docstring(self):
        """Tests for the review.py module docstring"""
...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        """Tests Review has attr place_id, and it's an empty string"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Tests Review has attr user_id, and it's an empty string"""
        review = Review()
    ...
    def test_text_attr(self):
        """Tests Review has attr text, and it's an empty string"""
        review = Review()
