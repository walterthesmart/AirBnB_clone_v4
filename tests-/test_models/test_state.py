...
"""
This script contains the TestStateDocs classes
"""
...
class TestStateDocs(unittest.TestCase):
    """Testx to check the documentation and style of State class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_state(self):
        """Tests that models/state.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_state(self):
        """Tests that tests/test_models/test_state.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_state_module_docstring(self):
        """Testx for the state.py module docstring"""
...
class TestState(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests that State has attribute name, and it's as an empty string"""
        state = State()
