...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_save(self):
        """Tests that save properly saves objects to the db"""

    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_get(self):
        """Tests that get retrieves an item in db properly"""

    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_count(self):
        """Tests that count returns the right number of elements in the db"""