...
"""
This script contains the TestPlaceDocs classes
"""
...
class TestPlaceDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_place(self):
        """Tests that models/place.py conforms to PEP8."""
    ...
    def test_place_module_docstring(self):
        """Tests for the place.py module docstring"""
...
class TestPlace(unittest.TestCase):
    ...
    def test_city_id_attr(self):
        """Tests Place has attr city_id, and it's an empty string"""
        place = Place()
    ...
    def test_user_id_attr(self):
        """Tests Place has attr user_id, and it's an empty string"""
        place = Place()
    ...
    def test_name_attr(self):
        """Tests Place has attr name, and it's an empty string"""
        place = Place()
    ...
    def test_description_attr(self):
        """Tests Place has attr description, and it's an empty string"""
        place = Place()
    ...
    def test_number_rooms_attr(self):
        """Tests Place has attr number_rooms, and it's an int == 0"""
        place = Place()
    ...
    def test_number_bathrooms_attr(self):
        """Tests Place has attr number_bathrooms, and it's an int == 0"""
        place = Place()
    ...
    def test_max_guest_attr(self):
        """Testx Place has attr max_guest, and it's an int == 0"""
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """Tests Place has attr price_by_night, and it's an int == 0"""
        place = Place()
    ...
    def test_latitude_attr(self):
        """Tests Place has attr latitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_longitude_attr(self):
        """Tests Place has attr longitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_amenity_ids_attr(self):
        """Tests Place has attr amenity_ids, and it's an empty list"""
        place = Place()
