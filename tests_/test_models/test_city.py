...
"""
This contains the TestCityDocs classes
"""
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests that City has attribute name, and it's an empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Tests that City has attribute state_id, and it's an empty string"""
        city = City()
